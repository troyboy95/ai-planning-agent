          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="shrink-0 flex items-center">
                <span className="font-bold text-xl text-indigo-900 tracking-tight">AI Planning Agent</span>
              </div>
              <div className="flex items-center gap-4">
                <Link 
                  href="/plan/new" 
                  className="bg-primary text-white hover:bg-primary/90 rounded-md px-4 py-2 text-sm font-medium flex items-center gap-2 transition-colors"
                >
